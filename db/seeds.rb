...
detail = [{:roomname => "ENGR301", :amount => 200, :type=>"classroom"},{:roomname => "ENGR302", :amount => 100, :type=>"classroom"},{:roomname => "ENGR303", :amount => 100, :type=>"classroom"},{:roomname => "ENGR304", :amount => 50, :type=>"classroom"},
          {:roomname => "ENGR305", :amount => 50, :type=>"classroom"},{:roomname => "ENGR306", :amount => 50, :type=>"classroom"},{:roomname => "ENGR307", :amount => 20, :type=>"classroom"},{:roomname => "ENGR308", :amount => 100, :type=>"classroom"},
           {:roomname => "ENGR309", :amount => 100, :type=>"classroom"},{:roomname => "ENGR310", :amount => 100, :type=>"classroom"}]
...
tools = [{:roomname=>"ENGR301",:amplifier=>1,:microphone=>1,:computer=>1,:visualizer=>1,:loudspeaker=>4},
         ...
         {:roomname=>"ENGR305",:amplifier=>1,:microphone=>1,:computer=>1,:overhead_projector=>1,:loudspeaker=>2},
         {:roomname=>"ENGR306",:amplifier=>1,:microphone=>1,:computer=>1,:overhead_projector=>1,:loudspeaker=>2},
         {:roomname=>"ENGR307",:amplifier=>1,:microphone=>1,:computer=>1,:overhead_projector=>1,:loudspeaker=>1},
         {:roomname=>"ENGR308",:amplifier=>1,:microphone=>1,:computer=>1,:visualizer=>1,:loudspeaker=>4,:overhead_projector=>1},
         {:roomname=>"ENGR309",:amplifier=>1,:microphone=>1,:computer=>1,:overhead_projector=>1,:loudspeaker=>4},
         {:roomname=>"ENGR310",:amplifier=>1,:microphone=>1,:computer=>1,:visualizer=>1,:loudspeaker=>4,:overhead_projector=>1}]
